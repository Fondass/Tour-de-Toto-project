 ...
 * 
 * classes/class.users.top.functions.php (model class)
 * 
 * javascript/ajax.users.top.js (ajax)
 * classes/ajax/class.ajax.users.top.php (ajax)
 * 
 * page that shows the top 10 athletes per comeptition
 */

class FonRidersPage extends FonPage
{
    ...
    {
        $this->functions->competitionSelect(10);
    }
}